...
def mask_out(vertices, wl, data_cube):
    """
    This function gives out: 2d image of the masked region, and the 3D masked data cube
    Input:
    vertices: The vertices (in spatial pixels coordinates) of the contour used for spectral extraction. e.g.: vertices = [(x1,y1), (x2,y2), (x3, y3),.............]
    wl: 2d white light image of the data cube
    data_cube: 3D data_cube. It can be either the flux or variance cubes.
